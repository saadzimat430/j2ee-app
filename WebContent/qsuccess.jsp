...
<head>
    ...
    <script>
	function goBack() {
		window.location.href = '/app/EspaceAdmin';
	}
	</script>
		        ...
		        <div class="container">
		            <div class="row justify-content-center">
		                <div class="col-lg-6">
		                	...
		                	<p><br></p>
		                	<button type="button" class="btn btn-secondary" onclick="goBack()">Retour à l'espace Admin</button>
		                	<p><br></p>
		                	<div class="form">
		                		<h2>Les questions ont été ajoutées avec succès.</h2>
		                	</div>
		                </div>
		            </div>
		        </div>
