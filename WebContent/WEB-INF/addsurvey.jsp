		        ...
		        <div class="container">
		            <div class="row justify-content-center">
		                <div class="col-lg-6">
		                	...
		                	<p><br></p>
		                	<div class="form">
	                		<form method="get" name="form" action="/app/AjouterQuestions">
							          <div class="form-group">
							            <label class="text-normal text-dark">Titre</label>
							            <input type="text" name="titre" class="form-control" Placeholder='Titre du questionnaire' pattern=".{2,}" required>
							          </div>
							          <div class="form-group">
							            <label class="text-normal text-dark">Description</label>
							            <input type="text" name="description" class="form-control" Placeholder='Description' pattern=".{2,}" required>
							          </div>
