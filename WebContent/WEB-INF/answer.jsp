		                ...
		                <div class="col-lg-6">
		                	...
		                	<div class="form">
		                		<form method="POST" name="form">
			                		<c:forEach items="${questions}" var="t" varStatus="question">
			                			<div class="container">
    										<div class="row">
    											<div class="form-row col-lg-9">
													<label class="text-normal text-dark"><a>${t}</a></label>
													<select class="form-control" id="reponse" name="reponse" onChange="getDetails()">
															<option value="">Vrai ou faux?</option>
															<option>Vrai</option>
															<option>Faux</option>
													</select>
												</div>
									...
									<div class="submit_btn">
		                                <button class="boxed-btn3" type="submit" value="Submit">
		                                Confirmer
		                                </button>
				                    </div>
				                	</div>
