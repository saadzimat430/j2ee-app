...
<head>
    ...
    <title>Envoyer recommandation</title>
    ...
    <script>
	function message() {
	  document.getElementById("message").innerHTML = "Votre recommandation a été soumise.";
	}
	</script>
		        ...
		        <div class="container">
		                ...
		                <div class="col-lg-3">
		                     ...
		                     <form method="post" id="form">
		                     	  <textarea id="recom" name="recom" placeholder="Entrez votre recommandation"></textarea>
								  <div class="submit_btn">
                                    <button onclick="message()" class="boxed-btn3" type="submit">Confirmer</button>
                                    <p><br></p>
                                  </div>
							</form>	
		            </div>
